...
FontTranslationTable *CreateEnglishTransTable(  )
{
  ...
  pTable = (FontTranslationTable *)MemAlloc(sizeof(FontTranslationTable));
	...
	*temp = 0; // "A" umlaut again (stupid huh?)
	temp++;
	*temp = 0; // "A" grave
	temp++;
	*temp = 0; // "A" acute
	...
	*temp = 128; // "C" cedile
	temp++;
	*temp = 0; // "E" umlaut again
	temp++;
	*temp = 0; // "E" grave
	temp++;
	*temp = 144;// "E" acute						// 140
	temp++;
	*temp = 0; // "E" circumflex
	temp++;
	*temp = 0; // "I" umlaut
	temp++;
	*temp = 0; // "O" umlaut again
	temp++;
	*temp = 0; // "O" grave
	temp++;
	*temp = 0; // "O" acute
	...
	*temp = 0; // "O" circumflex
	temp++;
	*temp = 0; // "U" umlaut again
	temp++;
	*temp = 0; // "U" grave
	temp++;
	*temp = 0; // "U" acute
	temp++;
	*temp = 0; // "U" circumflex				// 150
	temp++;

	*temp = 0; // "a" umlaut again 
	temp++;
	*temp = 0; // "a" grave
	temp++;
	*temp = 0; // "a" acute
