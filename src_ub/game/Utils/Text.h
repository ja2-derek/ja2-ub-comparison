...
//Ja25: Renamed:		#define		ITEMSTRINGFILENAME				"BINARYDATA\\ITEMDESC.EDT"
#define		ITEMSTRINGFILENAME				"BINARYDATA\\Itmdsc25.edt"
...
enum
{
	...
	GIO_TIMED_TURN_TITLE_TEXT,
	GIO_NO_TIMED_TURNS_TEXT,
	GIO_TIMED_TURNS_TEXT,
