...
STR16 pTransactionText[] =
{
	...
	L"Przed≥uøenie ubezpieczenia dla - %s", 				// johnny contract extended
	...
	L"", //String nuked
	L"Zakup kwiatÛw",
	L"Pe≥ny zwrot zastawu na øycie dla - %s",
	L"CzÍúciowy zwrot zastawu na øycie dla - %s",
	L"Brak zwrotu zastawu na øycie dla - %s",
	...
	L"Wyposaøenie samoobrony w - %s", // initial cost to equip a town's militia
...
STR16			sFuneralString[] =
{
	...
	L"Niestety nie wszystkie punkty ceremonii zosta≥y dope≥nione na tej stronie. Omy≥ka ta zapewne spowodowana jest g≥Íbokim øalem po stracie ukochanej osoby.",
	L"Sk≥adamy wyrazy najg≥Íbszego wspÛ≥czucia w tych ciÍøkich chwilach, jednak, to chyba nie wszystko."
};
...
STR16	zOptionsScreenHelpText[] =
{
	...
	//Never move my mouse
	L"W≥πcz tÍ opcjÍ, aby kursor myszki automatycznie ustawia≥ siÍ nad pojawiajπcymi siÍ okienkami dialogowymi.",
