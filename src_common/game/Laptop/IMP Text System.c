...
void LoadAndDisplayIMPText( INT16 sStartX, INT16 sStartY, INT16 sLineLength, INT16 sIMPTextRecordNumber, UINT32 uiFont, UINT8 ubColor, BOOLEAN fShadow, UINT32 uiFlags)
{
  ...
  INT32 iRecordPosition = 0;
   ...
   // load the string
	LoadEncryptedDataFromFile("BINARYDATA\\IMPTxt25.EDT", sString, ( UINT32 ) ( ( sIMPTextRecordNumber ) * IMP_SEEK_AMOUNT ), IMP_SEEK_AMOUNT);
...
void PrintImpText( void )
{
	...
	switch( iCurrentImpPage )
	{
     ...
     LoadAndDisplayIMPText( 258, LAPTOP_SCREEN_WEB_DELTA_Y +362, ( SCREEN_BUFFER_WIDTH ),IMP_HOME_5, FONT14ARIAL, FONT_BLACK, FALSE, 0);
     ...
     LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X, LAPTOP_SCREEN_WEB_DELTA_Y +402, sWidth, IMP_HOME_6, FONT12ARIAL, FONT_WHITE, TRUE, CENTER_JUSTIFIED);
		...
		break;	
		case ( IMP_ABOUT_US ):
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 17, LAPTOP_SCREEN_WEB_UL_Y + 137, ( SCREEN_BUFFER_WIDTH ),IMP_ABOUT_US_1, FONT12ARIAL, FONT_WHITE, TRUE, 0);
      ...
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 25, LAPTOP_SCREEN_WEB_UL_Y + 235, ( 337 - 124 ), IMP_ABOUT_US_3, FONT10ARIAL, 142, TRUE, 0);
			LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 17, LAPTOP_SCREEN_WEB_UL_Y + 260, ( SCREEN_BUFFER_WIDTH ), IMP_ABOUT_US_10, FONT12ARIAL, FONT_WHITE, TRUE, 0);
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 25, LAPTOP_SCREEN_WEB_UL_Y + 280, ( 337 - 124 ), IMP_ABOUT_US_4, FONT10ARIAL, 142, TRUE, 0);
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 267, LAPTOP_SCREEN_WEB_UL_Y + 137, ( SCREEN_BUFFER_WIDTH ), IMP_ABOUT_US_11, FONT12ARIAL, FONT_WHITE, TRUE, 0);
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 275, LAPTOP_SCREEN_WEB_UL_Y + 154, ( 337 - 129 ), IMP_ABOUT_US_5, FONT10ARIAL, 142, TRUE, 0);
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 267, LAPTOP_SCREEN_WEB_UL_Y + 227, ( SCREEN_BUFFER_WIDTH ), IMP_ABOUT_US_8, FONT12ARIAL, FONT_WHITE, TRUE, 0);
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 275, LAPTOP_SCREEN_WEB_UL_Y + 247, ( 337 - 129  ), IMP_ABOUT_US_6, FONT10ARIAL, 142, TRUE, 0);
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 267, LAPTOP_SCREEN_WEB_UL_Y + 277, ( SCREEN_BUFFER_WIDTH ), IMP_ABOUT_US_9, FONT12ARIAL, FONT_WHITE, TRUE, 0);
      ...
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 105, LAPTOP_SCREEN_WEB_UL_Y + 67, ( 390 - 105  ), IMP_BEGIN_2, FONT10ARIAL, 142, TRUE, CENTER_JUSTIFIED);
			...
			// fullname
			LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 81, LAPTOP_SCREEN_WEB_UL_Y + 139, ( SCREEN_BUFFER_WIDTH  ), IMP_BEGIN_3, FONT14ARIAL, FONT_BLACK, FALSE, 0);
			
			// nick name
			LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 81, LAPTOP_SCREEN_WEB_UL_Y + 199, ( SCREEN_BUFFER_WIDTH  ), IMP_BEGIN_4, FONT14ARIAL, FONT_BLACK, FALSE, 0);
      
			// gender
			LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 81, LAPTOP_SCREEN_WEB_UL_Y + 259, ( SCREEN_BUFFER_WIDTH  ), IMP_BEGIN_6, FONT14ARIAL, FONT_BLACK, FALSE, 0);
      
			// male
			LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 240, LAPTOP_SCREEN_WEB_UL_Y + 259, ( SCREEN_BUFFER_WIDTH  ), IMP_BEGIN_10, FONT14ARIAL, FONT_BLACK, FALSE, 0);
      
			// female
			LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 360, LAPTOP_SCREEN_WEB_UL_Y + 259, ( SCREEN_BUFFER_WIDTH  ), IMP_BEGIN_11, FONT14ARIAL, FONT_BLACK, FALSE, 0);
...
//			PrintIMPPersonalityQuizQuestionAndAnsers( );
    ...
    case( IMP_ATTRIBUTE_PAGE ):
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X, LAPTOP_SCREEN_WEB_UL_Y + 7, sWidth, IMP_ATTRIB_1 - 1, FONT14ARIAL, FONT_WHITE, TRUE, CENTER_JUSTIFIED);
			...
			{
			  LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 355, LAPTOP_SCREEN_WEB_UL_Y + 51, ( SCREEN_BUFFER_WIDTH  ), IMP_ATTRIB_SA_2 - 1, FONT12ARIAL, FONT_WHITE, TRUE, 0);
    ...
    case( IMP_ATTRIBUTE_FINISH ):
      ...
      LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X, LAPTOP_SCREEN_WEB_UL_Y + 7, sWidth, IMP_VOC_1 - 1, FONT14ARIAL, FONT_WHITE, TRUE, CENTER_JUSTIFIED);
		...
		break;
		case ( IMP_FINISH ):
      //LoadAndDisplayIMPText( LAPTOP_SCREEN_UL_X + 160, LAPTOP_SCREEN_WEB_UL_Y + 7, ( SCREEN_BUFFER_WIDTH  ), IMP_FIN_1 - 1, FONT14ARIAL, FONT_WHITE, TRUE, 0);
