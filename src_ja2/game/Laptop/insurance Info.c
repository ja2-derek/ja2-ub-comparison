...
void DisplayInfoTocPage()
{
  ...
  HVOBJECT hPixHandle;
	...
	DrawTextToScreen( sText, INS_INFO_TOC_SUBTITLE_X, usNewLineOffset, SCREEN_BUFFER_WIDTH-INS_INFO_INFO_TOC_TITLE_X, INS_FONT_BIG, INS_FONT_COLOR, FONT_MCOLOR_BLACK, FALSE, LEFT_JUSTIFIED );
