...
BOOLEAN EnterImportScreen()
{
	...
	guiJIS_ButtonStartFresh = CreateIconAndTextButton(giJIS_ButtonStartFreshImage,
								gzImportJa2ScreenText[IJS__START_FRESH_BTN],
								OPT_BUTTON_FONT,
								OPT_BUTTON_ON_COLOR,
								DEFAULT_SHADOW,
								...
								DEFAULT_SHADOW,
								TEXT_CJUSTIFIED,
								IJS__START_FRESH_BTN_LOC_X,
								IJS__START_FRESH_BTN_LOC_Y,
								BUTTON_TOGGLE,
								MSYS_PRIORITY_HIGH,
								DEFAULT_MOVE_CALLBACK,
								BtnIJS_StartFreshCallback);
	...
	guiJIS_ButtonImport = CreateIconAndTextButton(giJIS_ButtonImportImage,
							gzImportJa2ScreenText[IJS__IMPORT_BTN],
							OPT_BUTTON_FONT,
							OPT_BUTTON_ON_COLOR,
							DEFAULT_SHADOW,
							OPT_BUTTON_OFF_COLOR,
							DEFAULT_SHADOW,
							TEXT_CJUSTIFIED,
							IJS__IMPORT_BTN_LOC_X,
							IJS__IMPORT_BTN_LOC_Y,
							BUTTON_TOGGLE,
							MSYS_PRIORITY_HIGH,
							DEFAULT_MOVE_CALLBACK,
							BtnIJS_ImportCallback);
	...
	guiJIS_ButtonCancel = CreateIconAndTextButton(giJIS_ButtonCancelImage,
							gzImportJa2ScreenText[IJS__CANCEL_BTN],
							OPT_BUTTON_FONT,
							OPT_BUTTON_ON_COLOR,
							DEFAULT_SHADOW,
							OPT_BUTTON_OFF_COLOR,
							DEFAULT_SHADOW,
							TEXT_CJUSTIFIED,
							IJS__CANCEL_BTN_LOC_X,
							IJS__CANCEL_BTN_LOC_Y,
							BUTTON_TOGGLE,
							MSYS_PRIORITY_HIGH,
							DEFAULT_MOVE_CALLBACK,
							BtnIJS_CancelCallback);
...
void RenderImportScreen()
{
	...
	//Display the title
	DisplayWrappedString(IJS__TITLE_LOC_X, IJS__TITLE_LOC_Y, IJS__TITLE_LOC_WIDTH, 2,
				IJS_TITLE_FONT, IJS_HIGHLIGHT_COLOR, gzImportJa2ScreenText[IJS__TITLE],
				IJS_TITLE_SHADOW_COLOR, FALSE, CENTER_JUSTIFIED);


	//Display the desc of the page
	DisplayWrappedString(IJS__SUBSECTION_BODY_X, IJS__TITLE_DESC_Y, IJS__SUBSECTION_BODY_WIDTH, 2,
				IJS_SUBTITLE_FONT, IJS_DESC_COLOR, gzImportJa2ScreenText[IJS__TITLE_DESC],
				IJS_DESC_SHADOW, FALSE, LEFT_JUSTIFIED);


	//Display the title of the start fresh
	DisplayWrappedString(IJS__SUBSECTION_BODY_X, IJS__START_FRESH_TITLE_Y, IJS__SUBSECTION_BODY_WIDTH, 2,
				IJS_SUBTITLE_FONT, IJS_SUBTITLE_COLOR, gzImportJa2ScreenText[IJS__START_FRESH],
				IJS_SUBTITLE_SHADOW, FALSE, LEFT_JUSTIFIED);

	//Display the desc of the start fresh section
	DisplayWrappedString(IJS__SUBSECTION_BODY_X+IJS__DESC_OFFSET_X, IJS__START_FRESH_BODY_Y, IJS__SUBSECTION_BODY_WIDTH, 2,
				IJS_DESC_FONT, IJS_DESC_COLOR, gzImportJa2ScreenText[IJS__START_FRESH_DESC],
				IJS_DESC_SHADOW, FALSE, LEFT_JUSTIFIED);


	//Display the desc of the Import Title
	DisplayWrappedString(IJS__SUBSECTION_BODY_X, IJS__IMPORT_TITLE_Y, IJS__SUBSECTION_BODY_WIDTH, 2,
				IJS_SUBTITLE_FONT, IJS_SUBTITLE_COLOR, gzImportJa2ScreenText[IJS__IMPORT],
				IJS_SUBTITLE_SHADOW, FALSE, LEFT_JUSTIFIED);

	//Display the desc of the Import section 1
	uiNumPixels = DisplayWrappedString(IJS__SUBSECTION_BODY_X+IJS__DESC_OFFSET_X, IJS__IMPORT_BODY_Y_1, IJS__SUBSECTION_BODY_WIDTH, 2,
						IJS_DESC_FONT, IJS_DESC_COLOR, gzImportJa2ScreenText[IJS__IMPORT_DESC_1],
						IJS_DESC_SHADOW, FALSE, LEFT_JUSTIFIED);
	...
	DisplayWrappedString(IJS__SUBSECTION_BODY_X+IJS__DESC_OFFSET_X, (UINT16)(IJS__IMPORT_BODY_Y_1+uiNumPixels), IJS__SUBSECTION_BODY_WIDTH, 2,
				IJS_DESC_FONT, IJS_DESC_COLOR, gzImportJa2ScreenText[IJS__IMPORT_DESC_2],
				IJS_DESC_SHADOW, FALSE, LEFT_JUSTIFIED);
}
...
BOOLEAN DoImportMessageBox(UINT8 ubStyle, INT16 *zString, UINT32 uiExitScreen, UINT16 usFlags, MSGBOX_CALLBACK ReturnCallback)
{
	...
	giImportMessageBox = DoMessageBox(ubStyle, zString, uiExitScreen,
